    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".offers__slider")) new core(".offers__slider", {
                ...
                navigation: {
                    prevEl: ".slide-offers__arrow-left.swiper-button-prev",
                    nextEl: ".slide-offers__arrow-right.swiper-button-next"
                },
                breakpoints: {
                    319: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".record__slider")) new core(".record__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3.5,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slide-record__arrow-left.swiper-button-prev",
                    nextEl: ".slide-record__arrow-right.swiper-button-next"
                },
                breakpoints: {
                    319: {
                        slidesPerView: 1.5,
            ...
            if (document.querySelector(".service__slider")) new core(".service__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".slide-service__arrow-left.swiper-button-prev",
                    nextEl: ".slide-service__arrow-right.swiper-button-next"
                },
                breakpoints: {
                    319: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".work__slider")) new core(".work__slider", {
                ...
                navigation: {
                    prevEl: ".slide-work__arrow-left.swiper-button-prev",
                    nextEl: ".slide-work__arrow-right.swiper-button-next"
                },
                breakpoints: {
                    319: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".testination__slider")) new core(".testination__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                navigation: {
                    prevEl: ".slide-testination__arrow-left.swiper-button-prev",
                    nextEl: ".slide-testination__arrow-right.swiper-button-next"
                },
                breakpoints: {
                    319: {
                        slidesPerView: 1.2,
        ...
        da.init();
        let iconText = document.querySelector(".top-header__message");
        let closeButton = document.querySelector(".top-header__close");
        function showText() {
        ...
        document.querySelector(".top-header__in").addEventListener("mouseover", showText);
        closeButton.addEventListener("click", hideText);
        $(document).ready((function() {
            $("#phone").inputmask("+359(99) 999 99 99");
        }));
        const phoneInput = document.getElementById("phone");
        phoneInput.addEventListener("input", (event => {
            const input = event.target.value;
            const numbersOnly = input.replace(/\D/g, "");
            let formattedNumber = "+359";
            for (let i = 0; i < numbersOnly.length && i < 9; i++) if (i === 2 || i === 3 || i === 5 || i === 7) formattedNumber += `(${numbersOnly[i]}`; else if (i === 4 || i === 6 || i === 8) formattedNumber += `${numbersOnly[i]}) `; else formattedNumber += numbersOnly[i];
